      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '审核状态' : ''">
                  <el-select v-model="searchForm.sfsh" placeholder="审核状态" clearable style="width:100px">
		    ...
		    label="学生姓名">
		     <template slot-scope="scope">
              ...
              <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                  ...
                  <template slot-scope="scope">
                    <el-tag size="mini"
                      :type="{'已通过':'success','待审核':'warning','已驳回':'danger'}[scope.row.sfsh] || 'info'">
                      {{ scope.row.sfsh || '待审核' }}
                    </el-tag>
                  </template>
              </el-table-column>
      ...
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="审核状态">
          <el-select v-model="shForm.sfsh" placeholder="审核状态">
            ...
            <el-option label="驳回" value="已驳回"></el-option>
          </el-select>
        </el-form-item>
